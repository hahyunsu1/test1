...
public class ManagementController {
	...
	public String mainView(String cp, String ps,  Model model, HttpSession httpSession) {
	...
	public String registerPets(PetVO pet,  HttpServletRequest request,
...
//		
	...
	// 반려동물 등록2 페이지 보여주기
			@RequestMapping(value = "register2.bit")
			public String registerPets2() {
				return "management/register2";
			}
	// 반려동물 OCR이용 등록 처리
			@RequestMapping(value = "register2.bit", method = RequestMethod.POST)
			public String registerPets2(PetVO pet,  HttpServletRequest request,
					MultipartHttpServletRequest multiFile, RedirectAttributes redirectAttributes, Model model,
					HttpSession httpSession) {
