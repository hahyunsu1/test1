		...
		<table border="1" style="width: 90%; margin: auto; margin-top: 2em">
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="name"
					value="<%=user.getName()%>" id="name" placehoder="Name"> <br>
			...
			<tr>
				...
				<td width="80%" class="m2"><b
					...
					<%=(user.getStatus() == 0) ? "checked" : ""%> id="ra1">활동회원 <input
			...
			<tr>
				<td colspan="2" class="m3">
					<button type="button" onclick="member_check()">수정</button>
