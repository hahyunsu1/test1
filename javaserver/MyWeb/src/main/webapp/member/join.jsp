...
<div class="container">
	...
	*날짜 형식에 맞게 입력하세요 yyyy-mm-dd  or yyyy/mm/dd-->
	<!--이메일: <input type="text" name="birth"><br>
	  *이메일 형식에 맞게 입력하세요[aaa@naver.com] 이메일은 알파벳문자,숫자,하이픈(-)@naver.com-->
		<table border="1" style="width:90%;margin:auto;margin-top:2em">
			...
			<tr>
				...
				<td width="80%" class="m2">
				<input type="text" name="userid" id="userid" readonly placehoder="User ID">
