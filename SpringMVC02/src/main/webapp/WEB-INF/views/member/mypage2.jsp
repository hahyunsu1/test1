...
<div class="container mt-1" style="height: 720px;overFlow:auto;">
	...
	<!--  ---------------------------------------------------->
		<table class="table">
			<tr>
				...
				<input type="text" name="name" id="name" placehoder="Name" readonly>
			...
			<tr>
				...
				<td width="80%" class="m2">
				<input type="text" name="hp1" id="hp1" placehoder="HP1" maxlength="3">-
				<input type="text" name="hp2" id="hp2" placehoder="HP2" maxlength="4">-
				<input type="text" name="hp3" id="hp3" placehoder="HP3" maxlength="4">
			...
			<tr>
				...
				<td width="80%" class="m2">
				<input type="text" name="post" id="post" placehoder="Post" maxlength="5">
				<button type="button" class="btn btn-success"
				onclick="open_idcheck()"
				 >우편번호 찾기</button>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="m3 text-center">
					<button class="btn btn-primary" type="button" onclick="member_check()">수정</button>
