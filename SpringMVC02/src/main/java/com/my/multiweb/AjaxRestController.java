 ...
 *	 DELETE: /delete/3==> 3번 회원 정보를 삭제처리...
 */
...
public class AjaxRestController {
	...
	public MemoVO ajaxVO() {
		MemoVO vo=new MemoVO(55,"길철이","반가워요",null);
		return vo;
	}
	...
	@GetMapping(value="/ajaxVO6",produces="application/xml")
	public Map <String,String>ajaxVO6() {
	...
	@GetMapping(value="/ajaxVO7",produces="application/json")
	public Map <String,String>ajaxVO7() {
		Map <String,String> map=new HashMap();
		map.put("isbn", "778899");
		map.put("title", "Ajax입문");
		map.put("author", "홍길동");
